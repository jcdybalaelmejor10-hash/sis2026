...
export default function ManagerCompanyServicesPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {paginatedServices.length === 0 ? (
          ...
          <>
            <ManagerTable columns={columns} data={paginatedServices} onEdit={handleEdit} />
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={selectedService ? 'Editar Servicio' : 'Nuevo Servicio'}>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="number" step="0.01" value={formData.priceRef || ''} onChange={(e) => setFormData({ ...formData, priceRef: Number(e.target.value) || 0 })} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#5C8F2B] outline-none" min="0" placeholder="0.00" />
          </div>
