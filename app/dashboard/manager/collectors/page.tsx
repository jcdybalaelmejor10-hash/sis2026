...
export default function ManagerCollectorsPage() {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [collectorsData, companiesData] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {paginatedCollectors.length === 0 ? (
          ...
          <>
            <ManagerTable columns={columns} data={paginatedCollectors} onEdit={handleEdit} onToggleStatus={handleToggleStatus} />
